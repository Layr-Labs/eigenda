...
func (c *MockDAClient) GetInput(ctx context.Context, key EigenDACommitment) ([]byte, error) {
...
func (c *MockDAClient) SetInput(ctx context.Context, data []byte) (EigenDACommitment, error) {
	key := EigenDACommitment(data)
...
func (f *DAErrFaker) GetInput(ctx context.Context, key EigenDACommitment) ([]byte, error) {
...
func (f *DAErrFaker) SetInput(ctx context.Context, data []byte) (EigenDACommitment, error) {
