...
func TestQueryBatchesWithLimit(t *testing.T) {
	...
	subgraphClient := v2.NewSubgraphClient(mockSubgraphApi, logging.NewNoopLogger())
...
func TestQueryIndexedDeregisteredOperatorsForTimeWindow(t *testing.T) {
	...
	subgraphClient := v2.NewSubgraphClient(mockSubgraphApi, logging.NewNoopLogger())
	indexedDeregisteredOperatorState, err := subgraphClient.QueryIndexedOperatorsWithStateForTimeWindow(context.Background(), 1, v2.Deregistered)
	assert.NoError(t, err)
...
func TestQueryIndexedRegisteredOperatorsForTimeWindow(t *testing.T) {
	...
	mockSubgraphApi.On("QueryOperatorInfoByOperatorIdAtBlockNumber").Return(subgraphIndexedOperatorInfo1, nil)
	subgraphClient := v2.NewSubgraphClient(mockSubgraphApi, logging.NewNoopLogger())
	indexedRegisteredOperatorState, err := subgraphClient.QueryIndexedOperatorsWithStateForTimeWindow(context.Background(), 1, v2.Registered)
	assert.NoError(t, err)
...
func assertGasFees(t *testing.T, gasFees *v2.GasFees) {
