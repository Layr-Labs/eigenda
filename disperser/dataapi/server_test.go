...
var (
	...
	blobMetadataStoreV2    *blobstorev2.BlobMetadataStore
...
func TestCheckBatcherHealthExpectServing(t *testing.T) {
	r := setUpRouter()
	testDataApiServer = dataapi.NewServer(config, blobstore, prometheusClient, dataapi.NewSubgraphClient(mockSubgraphApi, mockLogger), mockTx, mockChainState, mockIndexedChainState, mockLogger, metrics, &MockGRPCConnection{}, nil, &MockHttpClient{ShouldSucceed: true}, blobMetadataStoreV2)
...
func TestCheckBatcherHealthExpectNotServing(t *testing.T) {
	...
	testDataApiServer = dataapi.NewServer(config, blobstore, prometheusClient, dataapi.NewSubgraphClient(mockSubgraphApi, mockLogger), mockTx, mockChainState, mockIndexedChainState, mockLogger, metrics, &MockGRPCConnection{}, nil, &MockHttpClient{ShouldSucceed: false}, blobMetadataStoreV2)
...
func TestFetchDisperserServiceAvailabilityHandler(t *testing.T) {
	...
	testDataApiServer = dataapi.NewServer(config, blobstore, prometheusClient, dataapi.NewSubgraphClient(mockSubgraphApi, mockLogger), mockTx, mockChainState, mockIndexedChainState, mockLogger, metrics, &MockGRPCConnection{}, mockHealthCheckService, nil, blobMetadataStoreV2)
...
func TestFetchDeregisteredOperatorNoSocketInfoOneOperatorHandler(t *testing.T) {
	...
	testDataApiServer = dataapi.NewServer(config, blobstore, prometheusClient, dataapi.NewSubgraphClient(mockSubgraphApi, mockLogger), mockTx, mockChainState, mockIndexedChainState, mockLogger, metrics, &MockGRPCConnection{}, nil, nil, blobMetadataStoreV2)
