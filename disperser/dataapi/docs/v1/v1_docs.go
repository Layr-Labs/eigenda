...
const docTemplateV1 = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.BlobsResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.BlobMetadataResponse"
                        }
                    },
                    "400": {
                        "description": "error: Bad request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.ServiceAvailabilityResponse"
                        }
                    },
                    "400": {
                        "description": "error: Bad request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.QueriedStateOperatorsResponse"
                        }
                    },
                    "400": {
                        "description": "error: Bad request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.QueriedOperatorEjectionsResponse"
                        }
                    },
                    "400": {
                        "description": "error: Bad request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.OperatorsStakeResponse"
                        }
                    },
                    "400": {
                        "description": "error: Bad request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.OperatorPortCheckResponse"
                        }
                    },
                    "400": {
                        "description": "error: Bad request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.SemverReportResponse"
                        }
                    },
                    "500": {
                        "description": "error: Server error",
    ...
    "definitions": {
        ...
        "v1.OperatorNonsigningPercentageMetrics": {
            "type": "object",
            "properties": {
                "operator_address": {
                    "type": "string"
        ...
        "v1.OperatorsNonsigningPercentage": {
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.OperatorNonsigningPercentageMetrics"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/v1.Meta"
            ...
            "properties": {
                "stake_ranked_operators": {
                    ...
                    "additionalProperties": {
                        "type": "array",
                        "items": {
                            "$ref": "#/definitions/v1.OperatorStake"
                        }
                    }
                }
            }
        ...
        "v1.QueriedStateOperatorMetadata": {
            "type": "object",
            "properties": {
                "block_number": {
                    "type": "integer"
        ...
        "v1.QueriedStateOperatorsResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.QueriedStateOperatorMetadata"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/v1.Meta"
        ...
        "v1.ServiceAvailabilityResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.ServiceAvailability"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/v1.Meta"
...
var SwaggerInfoV1 = &swag.Spec{
	...
	Description:      "This is the EigenDA Data Access API V1 server.",
	InfoInstanceName: "V1",
