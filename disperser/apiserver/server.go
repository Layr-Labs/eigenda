...
func (s *DispersalServer) disperseBlob(ctx context.Context, blob *core.Blob, authenticatedAddress string, apiMethodName string, paymentHeader *payment.PaymentMetadata) (*pb.DisperseBlobReply, error) {
