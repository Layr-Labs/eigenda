...
func NewConfig(ctx *cli.Context) (*Config, error) {
	...
	return &Config{
		...
		LevelDBDisableSeeksCompactionV1:     !ctx.GlobalBool(flags.LevelDBEnableSeeksCompactionV1Flag.Name),
		LevelDBSyncWritesV1:                 !ctx.GlobalBool(flags.LevelDBDisableSyncWritesV1Flag.Name),
		LevelDBDisableSeeksCompactionV2:     !ctx.GlobalBool(flags.LevelDBEnableSeeksCompactionV2Flag.Name),
		LevelDBSyncWritesV2:                 !ctx.GlobalBool(flags.LevelDBDisableSyncWritesV2Flag.Name),
