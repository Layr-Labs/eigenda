...
func (m *Map) Remove(lightNodeID int64) {
...
func (m *Map) Get(lightNodeID int64) *lightnode.Registration {
	entry, ok := m.lightNodes[lightNodeID]
	if !ok {
		return nil
	}
...
func (m *Map) GetChunkGroup(now time.Time, lightNodeID int64) (uint, bool) {
	m.shuffle(now)
...
func (m *Map) GetNodesInChunkGroup(
	now time.Time,
	chunkGroup uint) []*lightnode.Registration {
