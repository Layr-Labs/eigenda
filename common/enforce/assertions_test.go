...
func TestGreaterThan(t *testing.T) {
	...
	GreaterThan(1, 2, "This should panic, and the deferred function will catch it")
}
...
func TestGreaterThanOrEqual(t *testing.T) {
	...
	GreaterThanOrEqual(1, 2, "This should panic, and the deferred function will catch it")
}
...
func TestLessThan(t *testing.T) {
	...
	LessThan(2, 1, "This should panic, and the deferred function will catch it")
}
...
func TestLessThanOrEqual(t *testing.T) {
	...
	LessThanOrEqual(2, 1, "This should panic, and the deferred function will catch it")
}
