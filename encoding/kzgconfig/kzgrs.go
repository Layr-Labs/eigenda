...
// Config holds configuration for KZG prover and verifier.
// Some of the configurations only apply to the prover or verifier.
// Config is unfortunately used for both v1 and v2 structs,
// which is why we keep it under encoding/kzgconfig.
type Config struct {
