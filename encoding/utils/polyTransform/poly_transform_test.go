...
func TestPolyTransform_Oversize(t *testing.T) {
...
func TestPolyTransform_IncreaseCapacity(t *testing.T) {
	paddedData := codec.ConvertByPaddingEmptyByte(gettysburgAddressBytes)
	...
	// transformer needs to increase its capacity
