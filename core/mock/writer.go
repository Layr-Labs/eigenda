...
func (t *MockWriter) GetReservedPayments(ctx context.Context, accountIDs []gethcommon.Address, quorumNumbers []core.QuorumID) (map[gethcommon.Address]map[core.QuorumID]*core.ReservedPayment, error) {
	args := t.Called(ctx, accountIDs, quorumNumbers)
