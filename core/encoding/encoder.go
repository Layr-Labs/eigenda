...
// func toEncParams(params encoding.EncodingParams) encoding.EncodingParams {
...
// func (e *Encoder) Encode(data []byte, params encoding.EncodingParams) (encoding.BlobCommitments, []*encoding.Frame, error) {
...
// func (e *Encoder) VerifyBlobLength(commitments encoding.BlobCommitments) error {
...
// func (e *Encoder) VerifyChunks(chunks []*encoding.Frame, indices []encoding.ChunkNumber, commitments encoding.BlobCommitments, params encoding.EncodingParams) error {
...
// func (e *Encoder) VerifyCommitEquivalenceBatch(commitments []encoding.BlobCommitments) error {
...
// func (e *Encoder) UniversalVerifySubBatch(params encoding.EncodingParams, samplesCore []core.Sample, numBlobs int) error {
// 	encParams := toEncParams(params)
...
// func (e *Encoder) Decode(chunks []*encoding.Frame, indices []encoding.ChunkNumber, params encoding.EncodingParams, maxInputSize uint64) ([]byte, error) {
...
// func hashBlob(data []byte, params encoding.EncodingParams) string {
// 	h := sha256.New()
// 	h.Write(data)
