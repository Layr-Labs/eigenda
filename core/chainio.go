...
type Reader interface {
	...
	GetReservedPayments(ctx context.Context, accountIDs []gethcommon.Address, quorumNumbers []QuorumID) (map[gethcommon.Address]map[QuorumID]*ReservedPayment, error)
