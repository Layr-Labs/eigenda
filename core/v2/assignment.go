...
// ChunkRange represents a contiguous range of chunk indices [Start, End).
type ChunkRange struct {
	Start uint32 // inclusive
	End   uint32 // exclusive
}

// IndicesToRanges converts a list of chunk indices into contiguous ranges.
// Consecutive indices are collapsed into single ranges to minimize the number of requests.
//
...
func IndicesToRanges(indices []uint32) []ChunkRange {
