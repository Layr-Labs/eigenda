...
// Cache query on-chain states and filter socket updates through event logs to
// track the socket addresses of operators in a map.
type Cache struct {
...
func NewCache(reader core.Reader, client common.EthClient, logger logging.Logger) (*Cache, error) {
...
func (cs *Cache) GetOperatorStateByOperator(ctx context.Context, blockNumber uint, operator core.OperatorID) (*core.OperatorState, error) {
...
func (cs *Cache) GetOperatorState(ctx context.Context, blockNumber uint, quorums []core.QuorumID) (*core.OperatorState, error) {
...
func (cs *Cache) GetCurrentBlockNumber(ctx context.Context) (uint, error) {
...
// and it takes blockNumber due to the core.Cache interface.
func (cs *Cache) GetOperatorSocket(ctx context.Context, blockNumber uint, operator core.OperatorID) (string, error) {
...
func (cs *Cache) indexSocketMap(ctx context.Context) error {
...
func (cs *Cache) getSocketUpdateEventLogs(ctx context.Context) ([]types.Log, error) {
...
func (cs *Cache) parseOperatorSocketUpdate(log *types.Log) (core.OperatorID, string, error) {
...
func (cs *Cache) parseOperatorIDFromEventLog(log *types.Log) (core.OperatorID, error) {
	if len(log.Topics) < 2 {
...
func (cs *Cache) parseSocketFromEventLog(logData []byte) (string, error) {
...
func (cs *Cache) refreshSocketMap(ctx context.Context, operatorsByQuorum core.OperatorStakes) error {
...
func (cs *Cache) getOperatorState(ctx context.Context, operatorsByQuorum core.OperatorStakes, blockNumber uint32) (*core.OperatorState, error) {
	cs.socketMu.Lock()
