...
// LevelDBOffchainStore implements OffchainStore using LevelDB
type LevelDBOffchainStore struct {
	db     kvstore.Store[[]byte]
	logger logging.Logger
}

// NewLevelDBOffchainStore creates a new LevelDBOffchainStore
func NewLevelDBOffchainStore(
	path string,
	logger logging.Logger,
) (OffchainStore, error) {
...
func (s *LevelDBOffchainStore) UpdateReservationBin(ctx context.Context, accountID gethcommon.Address, reservationPeriod uint64, size uint64) (uint64, error) {
...
func (s *LevelDBOffchainStore) UpdateGlobalBin(ctx context.Context, reservationPeriod uint64, size uint64) (uint64, error) {
...
func (s *LevelDBOffchainStore) AddOnDemandPayment(ctx context.Context, paymentMetadata core.PaymentMetadata, paymentCharged *big.Int) (*big.Int, error) {
...
func (s *LevelDBOffchainStore) RollbackOnDemandPayment(ctx context.Context, accountID gethcommon.Address, newPayment, oldPayment *big.Int) error {
...
func (s *LevelDBOffchainStore) GetPeriodRecords(ctx context.Context, accountID gethcommon.Address, reservationPeriod uint64) ([MinNumBins]*pb.PeriodRecord, error) {
...
func (s *LevelDBOffchainStore) GetLargestCumulativePayment(ctx context.Context, accountID gethcommon.Address) (*big.Int, error) {
	key := buildOnDemandKey(accountID)
...
func (s *LevelDBOffchainStore) GetGlobalBinUsage(ctx context.Context, reservationPeriod uint64) (uint64, error) {
	key := buildGlobalBinKey(reservationPeriod)
...
func (s *LevelDBOffchainStore) GetReservationBin(ctx context.Context, accountID gethcommon.Address, reservationPeriod uint64) (uint64, error) {
	key := buildReservationKey(accountID, reservationPeriod)
...
func (s *LevelDBOffchainStore) GetOnDemandPayment(ctx context.Context, accountID gethcommon.Address) (*big.Int, error) {
	key := buildOnDemandKey(accountID)
...
func (s *LevelDBOffchainStore) GetGlobalBin(ctx context.Context, reservationPeriod uint64) (uint64, error) {
	key := buildGlobalBinKey(reservationPeriod)
...
func (s *LevelDBOffchainStore) Destroy() error {
	return s.db.Destroy()
}
