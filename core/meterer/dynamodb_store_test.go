...
func setupDynamoDBTest(t *testing.T) *dynamodbTestContext {
	tc := &dynamodbTestContext{
	...
	tc.store, err = meterer.NewDynamoDBOffchainStore(
		clientConfig,
		tc.reservationTable,
		tc.onDemandTable,
		tc.globalBinTable,
...
func cleanupTables(tc *dynamodbTestContext) {
...
// TestDynamoDBUpdateReservationBin tests the UpdateReservationBin function
func TestDynamoDBUpdateReservationBin(t *testing.T) {
	tc := setupDynamoDBTest(t)
...
// TestDynamoDBAddOnDemandPayment tests the AddOnDemandPayment function
func TestDynamoDBAddOnDemandPayment(t *testing.T) {
	tc := setupDynamoDBTest(t)
...
// TestDynamoDBRollbackOnDemandPayment tests the RollbackOnDemandPayment function
func TestDynamoDBRollbackOnDemandPayment(t *testing.T) {
	tc := setupDynamoDBTest(t)
...
// TestDynamoDBGetLargestCumulativePayment tests the GetLargestCumulativePayment function
func TestDynamoDBGetLargestCumulativePayment(t *testing.T) {
	tc := setupDynamoDBTest(t)
