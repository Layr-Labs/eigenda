...
func (_ContractIEigenDAEjectionManager *ContractIEigenDAEjectionManagerCaller) GetDepositAmount(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ContractIEigenDAEjectionManager.contract.Call(opts, &out, "getDepositAmount")
...
//
// Solidity: function getDepositAmount() view returns(uint256)
func (_ContractIEigenDAEjectionManager *ContractIEigenDAEjectionManagerSession) GetDepositAmount() (*big.Int, error) {
	return _ContractIEigenDAEjectionManager.Contract.GetDepositAmount(&_ContractIEigenDAEjectionManager.CallOpts)
}

// GetDepositAmount is a free data retrieval call binding the contract method 0x7d96f693.
//
// Solidity: function getDepositAmount() view returns(uint256)
func (_ContractIEigenDAEjectionManager *ContractIEigenDAEjectionManagerCallerSession) GetDepositAmount() (*big.Int, error) {
	return _ContractIEigenDAEjectionManager.Contract.GetDepositAmount(&_ContractIEigenDAEjectionManager.CallOpts)
}
