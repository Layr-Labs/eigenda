...
//
// Solidity: function initialize(address _initialOwner, uint32[] initABNs, address[] initCertVerifiers) returns()
func (_ContractEigenDACertVerifierRouter *ContractEigenDACertVerifierRouterTransactor) Initialize(opts *bind.TransactOpts, _initialOwner common.Address, initABNs []uint32, initCertVerifiers []common.Address) (*types.Transaction, error) {
	return _ContractEigenDACertVerifierRouter.contract.Transact(opts, "initialize", _initialOwner, initABNs, initCertVerifiers)
}

// Initialize is a paid mutator transaction binding the contract method 0x9d8ecd85.
//
// Solidity: function initialize(address _initialOwner, uint32[] initABNs, address[] initCertVerifiers) returns()
func (_ContractEigenDACertVerifierRouter *ContractEigenDACertVerifierRouterSession) Initialize(_initialOwner common.Address, initABNs []uint32, initCertVerifiers []common.Address) (*types.Transaction, error) {
	return _ContractEigenDACertVerifierRouter.Contract.Initialize(&_ContractEigenDACertVerifierRouter.TransactOpts, _initialOwner, initABNs, initCertVerifiers)
}

// Initialize is a paid mutator transaction binding the contract method 0x9d8ecd85.
//
// Solidity: function initialize(address _initialOwner, uint32[] initABNs, address[] initCertVerifiers) returns()
func (_ContractEigenDACertVerifierRouter *ContractEigenDACertVerifierRouterTransactorSession) Initialize(_initialOwner common.Address, initABNs []uint32, initCertVerifiers []common.Address) (*types.Transaction, error) {
	return _ContractEigenDACertVerifierRouter.Contract.Initialize(&_ContractEigenDACertVerifierRouter.TransactOpts, _initialOwner, initABNs, initCertVerifiers)
}
