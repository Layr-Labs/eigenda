...
// RegisterOperatorWithChurn0 is a paid mutator transaction binding the contract method 0xd68f3591.
//
...
func (_ContractEigenDARegistryCoordinator *ContractEigenDARegistryCoordinatorTransactor) RegisterOperatorWithChurn0(opts *bind.TransactOpts, quorumNumbers []byte, socket string, params IBLSApkRegistryPubkeyRegistrationParams, operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _ContractEigenDARegistryCoordinator.contract.Transact(opts, "registerOperatorWithChurn0", quorumNumbers, socket, params, operatorSignature)
}

// RegisterOperatorWithChurn0 is a paid mutator transaction binding the contract method 0xd68f3591.
//
// Solidity: function registerOperatorWithChurn(bytes quorumNumbers, string socket, ((uint256,uint256),(uint256,uint256),(uint256[2],uint256[2])) params, (bytes,bytes32,uint256) operatorSignature) returns()
func (_ContractEigenDARegistryCoordinator *ContractEigenDARegistryCoordinatorSession) RegisterOperatorWithChurn0(quorumNumbers []byte, socket string, params IBLSApkRegistryPubkeyRegistrationParams, operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _ContractEigenDARegistryCoordinator.Contract.RegisterOperatorWithChurn0(&_ContractEigenDARegistryCoordinator.TransactOpts, quorumNumbers, socket, params, operatorSignature)
}

// RegisterOperatorWithChurn0 is a paid mutator transaction binding the contract method 0xd68f3591.
//
// Solidity: function registerOperatorWithChurn(bytes quorumNumbers, string socket, ((uint256,uint256),(uint256,uint256),(uint256[2],uint256[2])) params, (bytes,bytes32,uint256) operatorSignature) returns()
func (_ContractEigenDARegistryCoordinator *ContractEigenDARegistryCoordinatorTransactorSession) RegisterOperatorWithChurn0(quorumNumbers []byte, socket string, params IBLSApkRegistryPubkeyRegistrationParams, operatorSignature ISignatureUtilsSignatureWithSaltAndExpiry) (*types.Transaction, error) {
	return _ContractEigenDARegistryCoordinator.Contract.RegisterOperatorWithChurn0(&_ContractEigenDARegistryCoordinator.TransactOpts, quorumNumbers, socket, params, operatorSignature)
}
