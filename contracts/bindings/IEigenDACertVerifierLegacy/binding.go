...
func (_ContractIEigenDACertVerifierLegacy *ContractIEigenDACertVerifierLegacyCaller) GetBlobParamsV2(opts *bind.CallOpts, version *big.Int) (EigenDATypesV2VersionedBlobParams, error) {
	var out []interface{}
	err := _ContractIEigenDACertVerifierLegacy.contract.Call(opts, &out, "getBlobParamsV2", version)
...
//
// Solidity: function getBlobParamsV2(uint256 version) view returns((uint32,uint32,uint32,uint32,uint32))
func (_ContractIEigenDACertVerifierLegacy *ContractIEigenDACertVerifierLegacySession) GetBlobParamsV2(version *big.Int) (EigenDATypesV2VersionedBlobParams, error) {
	return _ContractIEigenDACertVerifierLegacy.Contract.GetBlobParamsV2(&_ContractIEigenDACertVerifierLegacy.CallOpts, version)
}

// GetBlobParamsV2 is a free data retrieval call binding the contract method 0x904d21fc.
//
// Solidity: function getBlobParamsV2(uint256 version) view returns((uint32,uint32,uint32,uint32,uint32))
func (_ContractIEigenDACertVerifierLegacy *ContractIEigenDACertVerifierLegacyCallerSession) GetBlobParamsV2(version *big.Int) (EigenDATypesV2VersionedBlobParams, error) {
	return _ContractIEigenDACertVerifierLegacy.Contract.GetBlobParamsV2(&_ContractIEigenDACertVerifierLegacy.CallOpts, version)
}
...
func (_ContractIEigenDACertVerifierLegacy *ContractIEigenDACertVerifierLegacyTransactor) AddVersionedBlobParamsV2(opts *bind.TransactOpts, newVersionedBlobParams EigenDATypesV2VersionedBlobParams) (*types.Transaction, error) {
	return _ContractIEigenDACertVerifierLegacy.contract.Transact(opts, "addVersionedBlobParamsV2", newVersionedBlobParams)
}

// AddVersionedBlobParamsV2 is a paid mutator transaction binding the contract method 0x90574f90.
//
// Solidity: function addVersionedBlobParamsV2((uint32,uint32,uint32,uint32,uint32) newVersionedBlobParams) returns()
func (_ContractIEigenDACertVerifierLegacy *ContractIEigenDACertVerifierLegacySession) AddVersionedBlobParamsV2(newVersionedBlobParams EigenDATypesV2VersionedBlobParams) (*types.Transaction, error) {
	return _ContractIEigenDACertVerifierLegacy.Contract.AddVersionedBlobParamsV2(&_ContractIEigenDACertVerifierLegacy.TransactOpts, newVersionedBlobParams)
}

// AddVersionedBlobParamsV2 is a paid mutator transaction binding the contract method 0x90574f90.
//
// Solidity: function addVersionedBlobParamsV2((uint32,uint32,uint32,uint32,uint32) newVersionedBlobParams) returns()
func (_ContractIEigenDACertVerifierLegacy *ContractIEigenDACertVerifierLegacyTransactorSession) AddVersionedBlobParamsV2(newVersionedBlobParams EigenDATypesV2VersionedBlobParams) (*types.Transaction, error) {
	return _ContractIEigenDACertVerifierLegacy.Contract.AddVersionedBlobParamsV2(&_ContractIEigenDACertVerifierLegacy.TransactOpts, newVersionedBlobParams)
}
...
// ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2AddedIterator is returned from FilterVersionedBlobParamsV2Added and is used to iterate over the raw logs and unpacked data for VersionedBlobParamsV2Added events raised by the ContractIEigenDACertVerifierLegacy contract.
type ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2AddedIterator struct {
	Event *ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2Added // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2AddedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2Added)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2AddedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2AddedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2Added represents a VersionedBlobParamsV2Added event raised by the ContractIEigenDACertVerifierLegacy contract.
type ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2Added struct {
	Version             *big.Int
...
func (_ContractIEigenDACertVerifierLegacy *ContractIEigenDACertVerifierLegacyFilterer) FilterVersionedBlobParamsV2Added(opts *bind.FilterOpts, version []*big.Int) (*ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2AddedIterator, error) {
	...
	logs, sub, err := _ContractIEigenDACertVerifierLegacy.contract.FilterLogs(opts, "VersionedBlobParamsV2Added", versionRule)
	if err != nil {
		return nil, err
	}
	return &ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2AddedIterator{contract: _ContractIEigenDACertVerifierLegacy.contract, event: "VersionedBlobParamsV2Added", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event VersionedBlobParamsV2Added(uint256 indexed version, (uint32,uint32,uint32,uint32,uint32) versionedBlobParams)
func (_ContractIEigenDACertVerifierLegacy *ContractIEigenDACertVerifierLegacyFilterer) WatchVersionedBlobParamsV2Added(opts *bind.WatchOpts, sink chan<- *ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2Added, version []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _ContractIEigenDACertVerifierLegacy.contract.WatchLogs(opts, "VersionedBlobParamsV2Added", versionRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2Added)
				if err := _ContractIEigenDACertVerifierLegacy.contract.UnpackLog(event, "VersionedBlobParamsV2Added", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event VersionedBlobParamsV2Added(uint256 indexed version, (uint32,uint32,uint32,uint32,uint32) versionedBlobParams)
func (_ContractIEigenDACertVerifierLegacy *ContractIEigenDACertVerifierLegacyFilterer) ParseVersionedBlobParamsV2Added(log types.Log) (*ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2Added, error) {
	event := new(ContractIEigenDACertVerifierLegacyVersionedBlobParamsV2Added)
	if err := _ContractIEigenDACertVerifierLegacy.contract.UnpackLog(event, "VersionedBlobParamsV2Added", log); err != nil {
		return nil, err
	}
