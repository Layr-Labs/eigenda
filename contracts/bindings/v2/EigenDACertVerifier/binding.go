...
// the contract method with ID 0x19ec80f0.  This method will panic if any
// invalid/nil inputs are passed.
//
// Solidity: function decodeCert(bytes data) pure returns(((bytes32,uint32),(((uint16,bytes,((uint256,uint256),(uint256[2],uint256[2]),(uint256[2],uint256[2]),uint32),bytes32),bytes,uint32[]),uint32,bytes),(uint32[],(uint256,uint256)[],(uint256,uint256)[],(uint256[2],uint256[2]),(uint256,uint256),uint32[],uint32[],uint32[][]),bytes) cert)
func (contractEigenDACertVerifier *ContractEigenDACertVerifier) PackDecodeCert(data []byte) []byte {
	enc, err := contractEigenDACertVerifier.abi.Pack("decodeCert", data)
	if err != nil {
		panic(err)
	}
	return enc
...
// the contract method with ID 0x19ec80f0.  This method will return an error
// if any inputs are invalid/nil.
//
// Solidity: function decodeCert(bytes data) pure returns(((bytes32,uint32),(((uint16,bytes,((uint256,uint256),(uint256[2],uint256[2]),(uint256[2],uint256[2]),uint32),bytes32),bytes,uint32[]),uint32,bytes),(uint32[],(uint256,uint256)[],(uint256,uint256)[],(uint256[2],uint256[2]),(uint256,uint256),uint32[],uint32[],uint32[][]),bytes) cert)
func (contractEigenDACertVerifier *ContractEigenDACertVerifier) TryPackDecodeCert(data []byte) ([]byte, error) {
	return contractEigenDACertVerifier.abi.Pack("decodeCert", data)
}

// UnpackDecodeCert is the Go binding that unpacks the parameters returned
// from invoking the contract method with ID 0x19ec80f0.
//
// Solidity: function decodeCert(bytes data) pure returns(((bytes32,uint32),(((uint16,bytes,((uint256,uint256),(uint256[2],uint256[2]),(uint256[2],uint256[2]),uint32),bytes32),bytes,uint32[]),uint32,bytes),(uint32[],(uint256,uint256)[],(uint256,uint256)[],(uint256[2],uint256[2]),(uint256,uint256),uint32[],uint32[],uint32[][]),bytes) cert)
func (contractEigenDACertVerifier *ContractEigenDACertVerifier) UnpackDecodeCert(data []byte) (EigenDACertTypesEigenDACertV3, error) {
	out, err := contractEigenDACertVerifier.abi.Unpack("decodeCert", data)
	if err != nil {
