...
// contract deployment.
//
// Solidity: constructor(address initEigenDAThresholdRegistry, address initEigenDASignatureVerifier, (uint8,uint8) initSecurityThresholds, bytes initQuorumNumbersRequired, uint8 initOffchainDerivationVersion) returns()
func (contractEigenDACertVerifier *ContractEigenDACertVerifier) PackConstructor(initEigenDAThresholdRegistry common.Address, initEigenDASignatureVerifier common.Address, initSecurityThresholds EigenDATypesV1SecurityThresholds, initQuorumNumbersRequired []byte, initOffchainDerivationVersion uint8) []byte {
...
// invalid/nil inputs are passed.
//
// Solidity: function offchainDerivationVersion() view returns(uint8)
...
//
// Solidity: function offchainDerivationVersion() view returns(uint8)
func (contractEigenDACertVerifier *ContractEigenDACertVerifier) UnpackOffchainDerivationVersion(data []byte) (uint8, error) {
