...
// ErrorID returns the hash of canonical representation of the error's signature.
//
// Solidity: error InvalidOffchainDerivationVersion(uint16 certVersion, uint16 requiredVersion)
