...
// CheckDACertGasLimit is a free data retrieval call binding the contract method 0x8237f542.
//
// Solidity: function checkDACertGasLimit() view returns(uint32)
func (_ContractEigenDACertVerifier *ContractEigenDACertVerifierCaller) CheckDACertGasLimit(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _ContractEigenDACertVerifier.contract.Call(opts, &out, "checkDACertGasLimit")
...
//
// Solidity: function checkDACertGasLimit() view returns(uint32)
func (_ContractEigenDACertVerifier *ContractEigenDACertVerifierSession) CheckDACertGasLimit() (uint32, error) {
	return _ContractEigenDACertVerifier.Contract.CheckDACertGasLimit(&_ContractEigenDACertVerifier.CallOpts)
}

// CheckDACertGasLimit is a free data retrieval call binding the contract method 0x8237f542.
//
// Solidity: function checkDACertGasLimit() view returns(uint32)
func (_ContractEigenDACertVerifier *ContractEigenDACertVerifierCallerSession) CheckDACertGasLimit() (uint32, error) {
	return _ContractEigenDACertVerifier.Contract.CheckDACertGasLimit(&_ContractEigenDACertVerifier.CallOpts)
}
