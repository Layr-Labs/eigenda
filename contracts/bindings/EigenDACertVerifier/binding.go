...
func (_ContractEigenDACertVerifier *ContractEigenDACertVerifierCaller) OffchainDerivationVersion(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
...
//
// Solidity: function offchainDerivationVersion() view returns(uint8)
func (_ContractEigenDACertVerifier *ContractEigenDACertVerifierSession) OffchainDerivationVersion() (uint8, error) {
...
//
// Solidity: function offchainDerivationVersion() view returns(uint8)
func (_ContractEigenDACertVerifier *ContractEigenDACertVerifierCallerSession) OffchainDerivationVersion() (uint8, error) {
	return _ContractEigenDACertVerifier.Contract.OffchainDerivationVersion(&_ContractEigenDACertVerifier.CallOpts)
}
