...
// DecodeCert is a free data retrieval call binding the contract method 0x19ec80f0.
//
...
func (_ContractEigenDACertVerifier *ContractEigenDACertVerifierCaller) DecodeCert(opts *bind.CallOpts, data []byte) (EigenDACertTypesEigenDACertV3, error) {
	var out []interface{}
	err := _ContractEigenDACertVerifier.contract.Call(opts, &out, "decodeCert", data)
