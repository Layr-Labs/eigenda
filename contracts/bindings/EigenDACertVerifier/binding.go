...
// RecencyWindow is a free data retrieval call binding the contract method 0xa0330cd6.
//
// Solidity: function recencyWindow() view returns(uint32)
func (_ContractEigenDACertVerifier *ContractEigenDACertVerifierCaller) RecencyWindow(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _ContractEigenDACertVerifier.contract.Call(opts, &out, "recencyWindow")
...
//
// Solidity: function recencyWindow() view returns(uint32)
func (_ContractEigenDACertVerifier *ContractEigenDACertVerifierSession) RecencyWindow() (uint32, error) {
	return _ContractEigenDACertVerifier.Contract.RecencyWindow(&_ContractEigenDACertVerifier.CallOpts)
}

// RecencyWindow is a free data retrieval call binding the contract method 0xa0330cd6.
//
// Solidity: function recencyWindow() view returns(uint32)
func (_ContractEigenDACertVerifier *ContractEigenDACertVerifierCallerSession) RecencyWindow() (uint32, error) {
	return _ContractEigenDACertVerifier.Contract.RecencyWindow(&_ContractEigenDACertVerifier.CallOpts)
}
