...
contract SetupEigenDA is EigenDADeployer, EigenLayerUtils {
    ...
    function run() external {
        ...
        vm.serializeAddress(output, "clientAddress", address(clientAddress));
        vm.serializeString(output, "clientPrivateKey", "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcded");
