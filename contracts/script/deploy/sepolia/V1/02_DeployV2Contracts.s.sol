...
contract DeployV2Contracts is Script {
    ...
    function run() external {
        ...
        vm.startBroadcast(initParams.owner);
    ...
    function _deployRelayRegistry(InitParams memory initParams) internal {
        ...
        createdContracts.relayRegistry = address(
            new TransparentUpgradeableProxy(
                ...
                initParams.existing.daProxyAdmin,
                abi.encodeCall(EigenDARelayRegistry.initialize, (initParams.owner))
            )
        );
    }
    ...
    function _deployDisperserRegistry(InitParams memory initParams) internal {
        ...
        createdContracts.disperserRegistry = address(
            new TransparentUpgradeableProxy(
                ...
                initParams.existing.daProxyAdmin,
                abi.encodeCall(EigenDADisperserRegistry.initialize, (initParams.owner))
            )
        );
    }
