...
import "../../src/interfaces/IEigenDABlobVerifier.sol";
...
contract MockRollup {
    ...
    EigenDAServiceManager public eigenDAServiceManager; // EigenDASM contract
    BN254.G1Point public tau; //power of tau

    ///@notice mapping of timestamps to commitments
    mapping(uint256 => Commitment) public commitments;

    constructor(EigenDAServiceManager _eigenDAServiceManager, BN254.G1Point memory _tau) {
    ...
    function postCommitment(
        ...
        eigenDAServiceManager.verifyBlob(blobHeader, blobVerificationProof);
