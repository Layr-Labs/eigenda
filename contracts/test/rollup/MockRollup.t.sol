...
contract MockRollupTest is BLSMockAVSDeployer {
    ...
    function testChallenge(uint256 pseudoRandomNumber) public {
        ...
        (IEigenDAServiceManager.BlobHeader memory blobHeader, IEigenDABlobVerifier.BlobVerificationProof memory blobVerificationProof) = _getCommitment(pseudoRandomNumber);
    ...
    function _getCommitment(uint256 pseudoRandomNumber) internal returns (IEigenDAServiceManager.BlobHeader memory, IEigenDABlobVerifier.BlobVerificationProof memory){
        ...
        IEigenDABlobVerifier.BlobVerificationProof memory blobVerificationProof;
    ...
    function testGetQuorumAdversaryThreshold () public {
        require(eigenDAServiceManager.getQuorumAdversaryThresholdPercentage(0) == 33, "getQuorumAdversaryThreshold failed");
