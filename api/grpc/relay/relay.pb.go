...
type GetChunksRequest struct {
	...
	BlobKeys [][]byte `protobuf:"bytes,1,rep,name=blob_keys,json=blobKeys,proto3" json:"blob_keys,omitempty"`
	// A description of which chunks to request from each blob.
	//
	// Types that are assignable to Request:
	//
	//	*GetChunksRequest_ByIndex
	//	*GetChunksRequest_ByRange
	Request isGetChunksRequest_Request `protobuf_oneof:"request"`
	...
	RequesterSignature []byte `protobuf:"bytes,5,opt,name=requester_signature,json=requesterSignature,proto3" json:"requester_signature,omitempty"`
}
...
func (x *GetChunksRequest) GetBlobKeys() [][]byte {
	if x != nil {
		return x.BlobKeys
	}
	return nil
...
func (m *GetChunksRequest) GetRequest() isGetChunksRequest_Request {
	if m != nil {
		return m.Request
	}
	return nil
...
func (x *GetChunksRequest) GetByIndex() *ChunkRequestByIndex {
	if x, ok := x.GetRequest().(*GetChunksRequest_ByIndex); ok {
		return x.ByIndex
	}
	return nil
}

func (x *GetChunksRequest) GetByRange() *ChunkRequestByRange {
	if x, ok := x.GetRequest().(*GetChunksRequest_ByRange); ok {
		return x.ByRange
	}
	return nil
}
...
type isGetChunksRequest_Request interface {
	isGetChunksRequest_Request()
}

type GetChunksRequest_ByIndex struct {
	// Request chunks by their individual indices.
	ByIndex *ChunkRequestByIndex `protobuf:"bytes,2,opt,name=by_index,json=byIndex,proto3,oneof"`
}

type GetChunksRequest_ByRange struct {
	// Request chunks by a range of indices.
	ByRange *ChunkRequestByRange `protobuf:"bytes,3,opt,name=by_range,json=byRange,proto3,oneof"`
}

func (*GetChunksRequest_ByIndex) isGetChunksRequest_Request() {}

func (*GetChunksRequest_ByRange) isGetChunksRequest_Request() {}
...
var file_relay_relay_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x64, 0x65, 0x78, 0x22, 0x32, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x73,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x20, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x43, 0x68, 0x75, 0x6e, 0x6b,
	0x73, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x2e, 0x0a, 0x06, 0x43, 0x68, 0x75, 0x6e, 0x6b,
	0x73, 0x12, 0x24, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x10, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x46, 0x72, 0x61, 0x6d,
	0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x7b, 0x0a, 0x05, 0x52, 0x65, 0x6c, 0x61, 0x79,
...
var file_relay_relay_proto_goTypes = []interface{}{
	...
	(*GetChunksReply)(nil),      // 5: node.GetChunksReply
	(*Chunks)(nil),              // 6: node.Chunks
	(*v2.Frame)(nil),            // 7: common.v2.Frame
}
var file_relay_relay_proto_depIdxs = []int32{
	3, // 0: node.GetChunksRequest.by_index:type_name -> node.ChunkRequestByIndex
	4, // 1: node.GetChunksRequest.by_range:type_name -> node.ChunkRequestByRange
	6, // 2: node.GetChunksReply.data:type_name -> node.Chunks
	7, // 3: node.Chunks.data:type_name -> common.v2.Frame
	0, // 4: node.Relay.GetBlob:input_type -> node.GetBlobRequest
	2, // 5: node.Relay.GetChunks:input_type -> node.GetChunksRequest
	1, // 6: node.Relay.GetBlob:output_type -> node.GetBlobReply
	5, // 7: node.Relay.GetChunks:output_type -> node.GetChunksReply
...
func file_relay_relay_proto_init() {
	...
	file_relay_relay_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*GetChunksRequest_ByIndex)(nil),
		(*GetChunksRequest_ByRange)(nil),
	}
	type x struct{}
