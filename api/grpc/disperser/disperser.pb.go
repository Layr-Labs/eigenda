...
var file_disperser_disperser_proto_rawDesc = []byte{
	...
	0x49, 0x53, 0x50, 0x45, 0x52, 0x53, 0x49, 0x4e, 0x47, 0x10, 0x06, 0x32, 0xbc, 0x03, 0x0a, 0x09,
	...
	0x62, 0x44, 0x61, 0x74, 0x61, 0x22, 0x00, 0x12, 0x31, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x43, 0x68,
	0x75, 0x6e, 0x6b, 0x12, 0x10, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x68, 0x75,
	0x6e, 0x6b, 0x4b, 0x65, 0x79, 0x1a, 0x11, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43,
	0x68, 0x75, 0x6e, 0x6b, 0x44, 0x61, 0x74, 0x61, 0x22, 0x00, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69,
...
var file_disperser_disperser_proto_goTypes = []any{
	...
	(*common.BlobKey)(nil),        // 18: common.BlobKey
	(*common.ChunkKey)(nil),       // 19: common.ChunkKey
	(*common.BlobData)(nil),       // 20: common.BlobData
...
var file_disperser_disperser_proto_depIdxs = []int32{
	...
	18, // 17: disperser.Disperser.GetBlob:input_type -> common.BlobKey
	19, // 18: disperser.Disperser.GetChunk:input_type -> common.ChunkKey
	...
	20, // 23: disperser.Disperser.GetBlob:output_type -> common.BlobData
	21, // 24: disperser.Disperser.GetChunk:output_type -> common.ChunkData
...
func file_disperser_disperser_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_disperser_disperser_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_disperser_disperser_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_disperser_disperser_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_disperser_disperser_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_disperser_disperser_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_disperser_disperser_proto_msgTypes[15].Exporter = func(v any, i int) any {
	...
	file_disperser_disperser_proto_msgTypes[0].OneofWrappers = []any{
		(*AuthenticatedRequest_DisperseRequest)(nil),
		(*AuthenticatedRequest_AuthenticationData)(nil),
	}
	file_disperser_disperser_proto_msgTypes[1].OneofWrappers = []any{
