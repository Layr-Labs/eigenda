...
func (c *churnerClient) Churn(ctx context.Context, in *ChurnRequest, opts ...grpc.CallOption) (*ChurnReply, error) {
	...
	out := new(ChurnReply)
	err := c.cc.Invoke(ctx, Churner_Churn_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedChurnerServer must be embedded to have
...
func (UnimplementedChurnerServer) testEmbeddedByValue()                 {}
...
func RegisterChurnerServer(s grpc.ServiceRegistrar, srv ChurnerServer) {
	// If the following call pancis, it indicates UnimplementedChurnerServer was
