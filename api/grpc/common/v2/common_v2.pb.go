...
type PaymentHeader struct {
	...
	// The timestamp should be set as the time of the dispersal request, and will be used to determine the reservation period.
...
func (x *PaymentHeader) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
