...
type BlobHeader struct {
	...
	Commitment        *BlobCommitment `protobuf:"bytes,3,opt,name=commitment,proto3" json:"commitment,omitempty"`
	PaymentHeaderHash []byte          `protobuf:"bytes,4,opt,name=payment_header_hash,json=paymentHeaderHash,proto3" json:"payment_header_hash,omitempty"`
}
...
func (x *BlobHeader) GetCommitment() *BlobCommitment {
	if x != nil {
		return x.Commitment
	}
	return nil
...
func (x *BlobHeader) GetPaymentHeaderHash() []byte {
	if x != nil {
		return x.PaymentHeaderHash
	}
	return nil
}
...
type BlobCertificate struct {
	...
	ReferenceBlockNumber uint32      `protobuf:"varint,5,opt,name=reference_block_number,json=referenceBlockNumber,proto3" json:"reference_block_number,omitempty"`
...
func (x *BlobCertificate) GetBlobKey() []byte {
	if x != nil {
		return x.BlobKey
	}
	return nil
...
func (x *BlobCertificate) GetRelays() []string {
	if x != nil {
		return x.Relays
	}
	return nil
...
var file_common_common_proto_rawDesc = []byte{
	...
	0x0a, 0x64, 0x61, 0x74, 0x61, 0x4c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x22, 0xb5, 0x01, 0x0a, 0x0a,
	...
	0x65, 0x6e, 0x74, 0x12, 0x2e, 0x0a, 0x13, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x68,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x11, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x48,
	0x61, 0x73, 0x68, 0x22, 0xaf, 0x01, 0x0a, 0x0f, 0x42, 0x6c, 0x6f, 0x62, 0x43, 0x65, 0x72, 0x74,
	0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x6c, 0x6f, 0x62, 0x5f,
	0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x62, 0x6c, 0x6f, 0x62, 0x4b,
	0x65, 0x79, 0x12, 0x33, 0x0a, 0x0b, 0x62, 0x6c, 0x6f, 0x62, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x65,
	...
	0x62, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x34, 0x0a, 0x16, 0x72, 0x65, 0x66, 0x65, 0x72,
	0x65, 0x6e, 0x63, 0x65, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65,
	0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x14, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x16, 0x0a,
	0x06, 0x72, 0x65, 0x6c, 0x61, 0x79, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x72,
	0x65, 0x6c, 0x61, 0x79, 0x73, 0x22, 0x1f, 0x0a, 0x09, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x44, 0x61,
...
var file_common_common_proto_goTypes = []interface{}{
	...
	(*BlobHeader)(nil),      // 3: common.BlobHeader
	(*BlobCertificate)(nil), // 4: common.BlobCertificate
	(*ChunkData)(nil),       // 5: common.ChunkData
}
var file_common_common_proto_depIdxs = []int32{
	...
	2, // 3: common.BlobHeader.commitment:type_name -> common.BlobCommitment
	3, // 4: common.BlobCertificate.blob_header:type_name -> common.BlobHeader
