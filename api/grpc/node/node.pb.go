...
const (
	...
	RetrieveChunksReply_GOB     RetrieveChunksReply_ChunkEncoding = 1
	RetrieveChunksReply_GNARK   RetrieveChunksReply_ChunkEncoding = 2
)
...
type Bundle struct {
	...
	Chunks [][]byte `protobuf:"bytes,1,rep,name=chunks,proto3" json:"chunks,omitempty"`
	// All chunks of the bundle encoded in an byte array.
...
var file_node_node_proto_rawDesc = []byte{
	...
	0x12, 0x07, 0x0a, 0x03, 0x47, 0x4f, 0x42, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x47, 0x4e, 0x41,
	0x52, 0x4b, 0x10, 0x02, 0x22, 0x7e, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x62, 0x48,
...
var file_node_node_proto_depIdxs = []int32{
	...
	14, // 7: node.BlobHeader.commitment:type_name -> common.G1Commitment
	...
	3,  // 12: node.Retrieval.RetrieveChunks:input_type -> node.RetrieveChunksRequest
	5,  // 13: node.Retrieval.GetBlobHeader:input_type -> node.GetBlobHeaderRequest
	2,  // 14: node.Dispersal.StoreChunks:output_type -> node.StoreChunksReply
	4,  // 15: node.Retrieval.RetrieveChunks:output_type -> node.RetrieveChunksReply
	6,  // 16: node.Retrieval.GetBlobHeader:output_type -> node.GetBlobHeaderReply
