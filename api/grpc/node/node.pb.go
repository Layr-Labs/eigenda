...
var file_node_node_proto_goTypes = []interface{}{
	...
	(*NodeInfoRequest)(nil),       // 13: node.NodeInfoRequest
	(*NodeInfoReply)(nil),         // 14: node.NodeInfoReply
...
var file_node_node_proto_depIdxs = []int32{
	...
	13, // 11: node.Dispersal.NodeInfo:input_type -> node.NodeInfoRequest
	...
	13, // 14: node.Retrieval.NodeInfo:input_type -> node.NodeInfoRequest
	1,  // 15: node.Dispersal.StoreChunks:output_type -> node.StoreChunksReply
	14, // 16: node.Dispersal.NodeInfo:output_type -> node.NodeInfoReply
	...
	14, // 19: node.Retrieval.NodeInfo:output_type -> node.NodeInfoReply
