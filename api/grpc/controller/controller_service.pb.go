...
type AuthorizePaymentRequest struct {
	...
	// 3. The signature is over the BlobHeader, so it's needed in its entirety for signature verification
	BlobHeader *v2.BlobHeader `protobuf:"bytes,1,opt,name=blob_header,json=blobHeader,proto3" json:"blob_header,omitempty"`
	// Client signature over the keccak hash of the BlobHeader. Must verify against the AccountID public key, which is
	// included in the PaymentHeader.
	//
	...
	// Disperser signature over the keccak hash of this AuthorizePaymentRequest (excluding this signature field).
	// This proves that the request was created by an authorized disperser holding the KMS key.
	DisperserSignature []byte `protobuf:"bytes,3,opt,name=disperser_signature,json=disperserSignature,proto3" json:"disperser_signature,omitempty"`
}
...
var file_controller_controller_service_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x6e, 0x5f, 0x76, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xad, 0x01, 0x0a,
	0x17, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e,
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x36, 0x0a, 0x0b, 0x62, 0x6c, 0x6f, 0x62,
	...
	,
	...
	0x63, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_controller_controller_service_proto_goTypes = []interface{}{
	...
	(*AuthorizePaymentReply)(nil),   // 1: controller.AuthorizePaymentReply
...
var file_controller_controller_service_proto_depIdxs = []int32{
	...
	1, // 2: controller.ControllerService.AuthorizePayment:output_type -> controller.AuthorizePaymentReply
