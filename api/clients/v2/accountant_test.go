...
func TestNewAccountant(t *testing.T) {
	...
	paymentState := &v2.GetPaymentStateQuorumSpecificReply{
...
func TestSetPaymentState(t *testing.T) {
	...
	paymentState := &v2.GetPaymentStateQuorumSpecificReply{
		...
		PeriodRecords: map[uint32]*v2.PeriodRecords{
			0: {
				Records: []*v2.PeriodRecord{
					{
						Index: 123,
						Usage: 600,
					},
	...
	nilPaymentState := &v2.GetPaymentStateQuorumSpecificReply{
		PaymentVaultParams: &v2.PaymentVaultParams{
			QuorumPaymentConfigs: map[uint32]*v2.PaymentQuorumConfig{
				0: {
	...
	nilVaultParams := &v2.GetPaymentStateQuorumSpecificReply{
