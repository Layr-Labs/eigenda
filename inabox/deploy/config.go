...
func (env *Config) generateEncoderVars(ind int, grpcPort string) EncoderVars {
	v := EncoderVars{
		DISPERSER_ENCODER_CONFIG_LOG_FORMAT:                               "text",
		DISPERSER_ENCODER_CONFIG_AWS_REGION:                               "",
		DISPERSER_ENCODER_CONFIG_AWS_ACCESS_KEY:                           "",
		DISPERSER_ENCODER_CONFIG_AWS_SECRET_ACCESS_KEY:                    "",
		DISPERSER_ENCODER_CONFIG_AWS_ENDPOINT_URL:                         "",
		DISPERSER_ENCODER_CONFIG_GRPC_PORT:                                grpcPort,
		DISPERSER_ENCODER_CONFIG_METRICS_ENABLE_METRICS:                   "true",
		DISPERSER_ENCODER_CONFIG_KZG_G1_PATH:                              "",
		DISPERSER_ENCODER_CONFIG_KZG_G2_PATH:                              "",
		DISPERSER_ENCODER_CONFIG_KZG_SRS_ORDER:                            "",
		DISPERSER_ENCODER_CONFIG_KZG_SRS_NUMBER_TO_LOAD:                   "",
		DISPERSER_ENCODER_CONFIG_KZG_CACHE_DIR:                            "",
		DISPERSER_ENCODER_CONFIG_KZG_VERBOSE:                              "",
		DISPERSER_ENCODER_CONFIG_KZG_NUM_WORKER:                           fmt.Sprint(runtime.GOMAXPROCS(0)),
		DISPERSER_ENCODER_CONFIG_SERVER_MAX_CONCURRENT_REQUESTS_DANGEROUS: "16",
		DISPERSER_ENCODER_CONFIG_SERVER_REQUEST_POOL_SIZE:                 "32",
		DISPERSER_ENCODER_CONFIG_SERVER_REQUEST_QUEUE_SIZE:                "32",
	}
...
func (env *Config) generateEncoderV2Vars(ind int, grpcPort string) EncoderVars {
	v := EncoderVars{
		...
		DISPERSER_ENCODER_CONFIG_SERVER_MAX_CONCURRENT_REQUESTS_DANGEROUS: "16",
		DISPERSER_ENCODER_CONFIG_SERVER_REQUEST_POOL_SIZE:                 "32",
		DISPERSER_ENCODER_CONFIG_ENCODER_VERSION:                          "2",
		DISPERSER_ENCODER_CONFIG_BLOB_STORE_BUCKET_NAME:                   "test-eigenda-blobstore",
		DISPERSER_ENCODER_CONFIG_SERVER_REQUEST_QUEUE_SIZE:                "32",
	}
