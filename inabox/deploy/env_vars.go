...
type EncoderVars struct {
	DISPERSER_ENCODER_CONFIG_AWS_REGION string

	DISPERSER_ENCODER_CONFIG_AWS_ACCESS_KEY string

	DISPERSER_ENCODER_CONFIG_AWS_SECRET_ACCESS_KEY string

	DISPERSER_ENCODER_CONFIG_AWS_ENDPOINT_URL string

	DISPERSER_ENCODER_CONFIG_AWS_FRAGMENT_PARALLELISM_FACTOR string

	DISPERSER_ENCODER_CONFIG_AWS_FRAGMENT_PARALLELISM_CONSTANT string

	DISPERSER_ENCODER_CONFIG_GRPC_PORT string

	DISPERSER_ENCODER_CONFIG_METRICS_HTTP_PORT string

	DISPERSER_ENCODER_CONFIG_METRICS_ENABLE_METRICS string

	DISPERSER_ENCODER_CONFIG_SERVER_MAX_CONCURRENT_REQUESTS_DANGEROUS string

	DISPERSER_ENCODER_CONFIG_SERVER_REQUEST_POOL_SIZE string

	DISPERSER_ENCODER_CONFIG_SERVER_REQUEST_QUEUE_SIZE string

	DISPERSER_ENCODER_CONFIG_SERVER_ENABLE_GNARK_CHUNK_ENCODING string

	DISPERSER_ENCODER_CONFIG_ENCODER_VERSION string

	DISPERSER_ENCODER_CONFIG_BLOB_STORE_BUCKET_NAME string

	DISPERSER_ENCODER_CONFIG_BLOB_STORE_BACKEND string

	DISPERSER_ENCODER_CONFIG_BLOB_STORE_OCI_REGION string

	DISPERSER_ENCODER_CONFIG_BLOB_STORE_OCI_COMPARTMENT_ID string

	DISPERSER_ENCODER_CONFIG_BLOB_STORE_OCI_NAMESPACE string

	DISPERSER_ENCODER_CONFIG_SERVER_GPU_ENABLE string

	DISPERSER_ENCODER_CONFIG_SERVER_BACKEND string

	DISPERSER_ENCODER_CONFIG_SERVER_PREVENT_REENCODING string

	DISPERSER_ENCODER_CONFIG_SERVER_PPROF_HTTP_PORT string

	DISPERSER_ENCODER_CONFIG_SERVER_ENABLE_PPROF string

	DISPERSER_ENCODER_CONFIG_KZG_G1_PATH string

	DISPERSER_ENCODER_CONFIG_KZG_G2_PATH string

	DISPERSER_ENCODER_CONFIG_KZG_G2_TRAILING_PATH string

	DISPERSER_ENCODER_CONFIG_KZG_CACHE_DIR string

	DISPERSER_ENCODER_CONFIG_KZG_SRS_ORDER string

	DISPERSER_ENCODER_CONFIG_KZG_SRS_NUMBER_TO_LOAD string

	DISPERSER_ENCODER_CONFIG_KZG_NUM_WORKER string

	DISPERSER_ENCODER_CONFIG_KZG_VERBOSE string

	DISPERSER_ENCODER_CONFIG_KZG_PRELOAD_ENCODER string

	DISPERSER_ENCODER_CONFIG_LOG_PATH string

	DISPERSER_ENCODER_CONFIG_LOG_FORMAT string

	DISPERSER_ENCODER_CONFIG_LOG_LEVEL string
}
