...
type EncoderVars struct {
	ENCODER_CONFIG_AWS_REGION string

	ENCODER_CONFIG_AWS_ACCESS_KEY string

	ENCODER_CONFIG_AWS_SECRET_ACCESS_KEY string

	ENCODER_CONFIG_AWS_ENDPOINT_URL string

	ENCODER_CONFIG_AWS_FRAGMENT_PARALLELISM_FACTOR string

	ENCODER_CONFIG_AWS_FRAGMENT_PARALLELISM_CONSTANT string

	ENCODER_CONFIG_GRPC_PORT string

	ENCODER_CONFIG_METRICS_HTTP_PORT string

	ENCODER_CONFIG_METRICS_ENABLE_METRICS string

	ENCODER_CONFIG_SERVER_MAX_CONCURRENT_REQUESTS_DANGEROUS string

	ENCODER_CONFIG_SERVER_REQUEST_POOL_SIZE string

	ENCODER_CONFIG_SERVER_REQUEST_QUEUE_SIZE string

	ENCODER_CONFIG_SERVER_ENABLE_GNARK_CHUNK_ENCODING string

	ENCODER_CONFIG_ENCODER_VERSION string

	ENCODER_CONFIG_BLOB_STORE_BUCKET_NAME string

	ENCODER_CONFIG_BLOB_STORE_BACKEND string

	ENCODER_CONFIG_BLOB_STORE_OCI_REGION string

	ENCODER_CONFIG_BLOB_STORE_OCI_COMPARTMENT_ID string

	ENCODER_CONFIG_BLOB_STORE_OCI_NAMESPACE string

	ENCODER_CONFIG_CHUNK_STORE_BUCKET_NAME string

	ENCODER_CONFIG_SERVER_GPU_ENABLE string

	ENCODER_CONFIG_SERVER_BACKEND string

	ENCODER_CONFIG_SERVER_PREVENT_REENCODING string

	ENCODER_CONFIG_SERVER_PPROF_HTTP_PORT string

	ENCODER_CONFIG_SERVER_ENABLE_PPROF string

	ENCODER_CONFIG_KZG_G1_PATH string

	ENCODER_CONFIG_KZG_G2_PATH string

	ENCODER_CONFIG_KZG_G2_TRAILING_PATH string

	ENCODER_CONFIG_KZG_CACHE_DIR string

	ENCODER_CONFIG_KZG_SRS_ORDER string

	ENCODER_CONFIG_KZG_SRS_NUMBER_TO_LOAD string

	ENCODER_CONFIG_KZG_NUM_WORKER string

	ENCODER_CONFIG_KZG_VERBOSE string

	ENCODER_CONFIG_KZG_PRELOAD_ENCODER string

	ENCODER_CONFIG_LOG_PATH string

	ENCODER_CONFIG_LOG_FORMAT string

	ENCODER_CONFIG_LOG_LEVEL string
}
