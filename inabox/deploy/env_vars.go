...
type DisperserVars struct {
	...
	DISPERSER_SERVER_ADDRESS_DIRECTORY string
...
type BatcherVars struct {
	...
	BATCHER_ADDRESS_DIRECTORY string
...
type RetrieverVars struct {
	...
	RETRIEVER_ADDRESS_DIRECTORY string
...
type ChurnerVars struct {
	...
	CHURNER_ADDRESS_DIRECTORY string
...
type ControllerVars struct {
	...
	CONTROLLER_ADDRESS_DIRECTORY string
...
type RelayVars struct {
	...
	RELAY_ADDRESS_DIRECTORY_ADDR string
