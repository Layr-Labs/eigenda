...
type DisperserVars struct {
	...
	DISPERSER_SERVER_NTP_SERVER string

	DISPERSER_SERVER_NTP_SYNC_INTERVAL string
...
type RelayVars struct {
	...
	RELAY_USE_POSTGRES string

	RELAY_POSTGRES_HOST string

	RELAY_POSTGRES_PORT string

	RELAY_POSTGRES_DATABASE string

	RELAY_POSTGRES_USERNAME string

	RELAY_POSTGRES_PASSWORD string

	RELAY_POSTGRES_SSL_MODE string
