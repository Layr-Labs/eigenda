...
type OperatorVars struct {
	...
	NODE_DISPERSER_RATE_LIMIT_PER_SECOND string

	NODE_DISPERSER_RATE_LIMIT_BURST string
	...
	NODE_ON_DEMAND_METER_REFRESH_INTERVAL string

	NODE_ON_DEMAND_METER_FUZZ_FACTOR string

	NODE_ENABLE_PER_ACCOUNT_PAYMENT_METRICS string

	NODE_OVERRIDE_V2_TTL string

	NODE_ENFORCE_SINGLE_BLOB_BATCHES string

	NODE_DEPRECATE_V1 string
