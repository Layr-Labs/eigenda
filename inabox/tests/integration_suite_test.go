...
var (
	...
	verifierContract    *verifierbindings.ContractEigenDACertVerifierV1V2
...
var _ = BeforeSuite(func() {
	...
	if testConfig.Environment.IsLocal() {
		...
		Expect(err).To(BeNil())
		verifierContract, err = verifierbindings.NewContractEigenDACertVerifierV1V2(gcommon.HexToAddress(testConfig.EigenDA.CertVerifier), ethClient)
		Expect(err).To(BeNil())
