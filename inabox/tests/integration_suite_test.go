...
func setupRetrievalClients(testConfig *deploy.Config) error {
	...
	tx, err := eth.NewWriter(logger, ethClient, testConfig.Retriever.RETRIEVER_BLS_OPERATOR_STATE_RETRIEVER, testConfig.Retriever.RETRIEVER_EIGENDA_SERVICE_MANAGER, "0x0000000000000000000000000000000000000000")
	if err != nil {
		return err
	}
