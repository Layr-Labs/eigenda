...
Graph node services (Postgres, IPFS, and Graph Node) are automatically managed through testcontainers and their logs can be viewed using standard Docker commands:
