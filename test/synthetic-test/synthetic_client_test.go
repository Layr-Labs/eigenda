...
// 	V1CertVerifier      *verifierv1bindings.ContractEigenDACertVerifierV1
// 	Logger              *log.Logger
...
// 	var mockRollup *verifierv1bindings.ContractMockRollup
// 	if validateOnchainTransaction {
// 		log.Printf("Create instance of MockRollUp with Contract Address %s", mockRollUpContractAddress)
// 		mockRollup, err = verifierv1bindings.NewContractMockRollup(gcommon.HexToAddress(mockRollUpContractAddress), ethClient)
// 		if err != nil {
// 			logger.Printf("Error: %v", err)
// 			return nil
// 		}
...
// func blobHeaderFromProto(blobHeader *disperser_rpc.BlobHeader) verifierv1bindings.IEigenDAServiceManagerBlobHeader {
...
// 	quorums := make([]verifierv1bindings.IEigenDAServiceManagerQuorumBlobParam, len(blobHeader.GetBlobQuorumParams()))
// 	for i, quorum := range blobHeader.GetBlobQuorumParams() {
// 		quorums[i] = verifierv1bindings.IEigenDAServiceManagerQuorumBlobParam{
...
// 	return verifierv1bindings.IEigenDAServiceManagerBlobHeader{
// 		Commitment: verifierv1bindings.BN254G1Point{
...
// func blobVerificationProofFromProto(verificationProof *disperser_rpc.BlobVerificationProof) verifierv1bindings.EigenDARollupUtilsBlobVerificationProof {
// 	logger := testSuite.Logger
...
// 	batchHeader := verifierv1bindings.IEigenDAServiceManagerBatchHeader{
...
// 	batchMetadata := verifierv1bindings.IEigenDAServiceManagerBatchMetadata{
...
// 	return verifierv1bindings.EigenDARollupUtilsBlobVerificationProof{
